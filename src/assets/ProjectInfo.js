const allProjects = [
    ...
    {
        title: "Note-Taker",
        description: "Application that is used to write and save notes. Through Express.js back end and will save and retrieve note data from a JSON file.",
    ...
    },
    {
        ...
        description: "Create a simple Word Guessing game with timer, lives and difficulty selection",
        used: ["CSS", 'HTML', "JAVASCRIPT"],
        imageLinks: [],
